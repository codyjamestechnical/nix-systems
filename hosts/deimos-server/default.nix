{ inputs, config, pkgs, ... }:
{
    ...
    fileSystems."/docker-data" = {
        ...
        automount_opts = "x-systemd.automount,noauto,x-systemd.idle-timeout=60,x-systemd.device-timeout=5s,x-systemd.mount-timeout=5s,file_mode=0770,dir_mode=0770,uid=995,gid=131,mfsymlinks,seal";
